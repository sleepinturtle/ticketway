...
<%--                   <input type="hidden" name="mem_uid" value="${dto.mem_uid }"/> --%>
                  <td><button  type="submit" class="btn btn-outline-secondary btn-sm" onclick="location.href='${pageContext.request.contextPath }/theaterAdmin/update_user?mno=${dto.mno }'">수정</button>
                  </form>
                  &nbsp;
                  <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#staticBackdrop${status.index }">삭제</button></td>
               </tr>
            </c:forEach>
  </tbody>
