...
<hr>
	...
	<div class="container">
		...
		<div class="row text-center">
			...
			<input type="hidden" name="play_no" value="${list.play_no}"/>
			<table class="table col-sm-12">
				<tr>
					<td><label class="control-label col-sm-12">공연번호</label></td>
				...
				<tr>
					...
					<td><input type="text" class="form-control" id="fname" name="mov_title" value="${list.play_title }"></td>
				</tr>
				<tr>
					<td><label class="control-label col-sm-12">장르</label></td>
					<td><input type="text" class="form-control" name="mov_genre" id="comment" value="${list.genre }"></td>
				</tr>
				<tr>
					<td><label class="control-label col-sm-12">공연등급</label></td>
					<td><input class="form-control" name="mov_grade" value="${list.rated }"></td>
				</tr>
				<tr>
					<td><label class="control-label col-sm-12">러닝타임</label></td>
					<td><input type="number" class="form-control" name="mov_runtime" placeholder="숫자만 입력해 주세요" value="${list.runtime }"></td>
				</tr>
				<tr>
