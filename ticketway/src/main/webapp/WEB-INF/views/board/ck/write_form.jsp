...
<html>
	...
	<%@ include file="/WEB-INF/views/header.jsp" %>
		...
		<a href="${pageContext.request.contextPath}/board/ck/list">
	...
	$(document).ready(function() {
		$("#write_btn").click(function() {
			...
			$.post(
					"${pageContext.request.contextPath}/board/ck/write"
					, {
						title : $("#title").val()
