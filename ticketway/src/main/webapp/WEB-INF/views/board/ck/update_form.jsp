...
<html>
	...
	<%@ include file="/WEB-INF/views/header.jsp" %>
		...
		<table class="table table-hover">
			<tbody>
				...
				<tr>
					<th> 내 용 </th>
					<td>
						<textarea class="form-contol" id="contents" name="contents">${detail_dto.contents}</textarea>
		...
		<a href="${pageContext.request.contextPath}/board/ck/detail?board_no=${detail_dto.board_no}">
	...
	$(document).ready(function() {
		$("#write_btn").click(function() {
			...
			$.post(
					"${pageContext.request.contextPath}/board/ck/update"
					, {
					...
					, function(data, status) {
						if(data >= 1){
							alert("게시글을 수정 하였습니다.");
							location.href="${pageContext.request.contextPath}/board/ck/list";
						} else if(data <= 0){
