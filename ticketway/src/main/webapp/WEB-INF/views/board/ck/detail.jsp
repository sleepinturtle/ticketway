...
<html>
	<head>
		<meta charset="UTF-8">
		<title> CKEDITOR 게시판 상세 보기 </title>
	...
	<%@ include file="/WEB-INF/views/header.jsp" %>
		...
		<c:if test="${detail_dto.mno == login_info.mno}">
			...
			<a href="${pageContext.request.contextPath}/board/ck/update_form?board_no=${detail_dto.board_no}">
	...
	$(document).ready(function() {
		$("#btn_delete").click(function() {
			...
			$.get(
					"${pageContext.request.contextPath}/board/ck/delete"
					, {
