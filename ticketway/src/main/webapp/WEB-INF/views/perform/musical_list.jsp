				...
				<div class="common_tab_area">
					<ul class="common_tab_list" role="tablist">
						<li class="common_tab_item" role="none">
							<button type="button" class="common_tab_btn" role="tab" aria-selected="true">뮤지컬</button></li>
<!-- 						<li class="common_tab_item" role="none"> -->
	...
	<div class="swiper">
	  ...
	  <div class="swiper-wrapper">
	    ...
	    <div class="swiper-slide">
	    	<img alt="slide1" src="${path}/resources/img/BigBanner_PC_미세스다웃파이어.jpg">
		</div>
	    <div class="swiper-slide">
	    	<img alt="slide1" src="${path}/resources/img/BigBanner_PC_푸에르자.jpg">
	    </div>
