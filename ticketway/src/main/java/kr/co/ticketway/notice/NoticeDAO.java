...
public class NoticeDAO {
	...
	public List<NoticeDTO> noticesearchList( SearchDTO dto ) {
		...
		list = sqlSession.selectList("NoticeMapper.noticesearchList", dto);
		return list;
	}//searchList
	
	public List<NoticeDTO> eventsearchList( SearchDTO dto ) {
		List<NoticeDTO> list = null;
		list = sqlSession.selectList("NoticeMapper.eventsearchList", dto);
		return list;
	}//searchList
	...
	public int cmtdelete( NoticeDTO dto ) {
		int successCount = 0;
		successCount = sqlSession.delete("NoticeMapper.cmtdelete", dto);
		return successCount;
	}//delete
	...
	public List<NoticeDTO> qnasearchList( SearchDTO dto ) {
		List<NoticeDTO> list = null;
		list = sqlSession.selectList("NoticeMapper.qnasearchList", dto);
		return list;
	}//qnasearchList
	...
	public int noticesearchListCount( SearchDTO dto ) {
		int totalCount = 0;
		totalCount = sqlSession.selectOne("NoticeMapper.noticesearchListCount", dto);
		return totalCount;
	}//searchListCount
	
	public int eventsearchListCount( SearchDTO dto ) {
		int totalCount = 0;
		totalCount = sqlSession.selectOne("NoticeMapper.eventsearchListCount", dto);
		return totalCount;
	}//searchListCount
